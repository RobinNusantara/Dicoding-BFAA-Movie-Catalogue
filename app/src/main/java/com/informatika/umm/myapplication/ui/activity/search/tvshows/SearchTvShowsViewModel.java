...
/**
 * MADE_Submission_2
 * created by : Robin Nusantara on 1/23/2020 01 2020
 * 17:31 Thu
 **/
public class SearchTvShowsViewModel extends ViewModel {
    ...
    public void loadSearchTvShows(String query) {
        Service apiService = Client.getClient().create(Service.class);
        Call<MovieResponse> call = apiService.getSearchMovies("tv", BuildConfig.API_KEY, BuildConfig.LANGUAGE, query);
    ...
    LiveData<List<Movie>> getSearchTvShows(){
        return movieList;
    }
}
