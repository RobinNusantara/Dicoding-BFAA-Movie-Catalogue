...
import com.informatika.umm.myapplication.ui.fragment.movies.MovieViewModel;
...
public class MovieDetailActivity extends AppCompatActivity {
    ...
    private void loadMovieDetail(int id) {
        ...
        Call<Movie> call = apiService.getMovieDetails("movie", id, BuildConfig.API_KEY, BuildConfig.LANGUAGE);
            ...
            public void onResponse(@NonNull Call<Movie> call, @NonNull Response<Movie> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (movies != null) {
                        ...
                        txtMovieRuntime.setText(FormatRuntime.getFormatRuntimeMovie(MovieDetailActivity.this, movies.getMovieRuntime()));
